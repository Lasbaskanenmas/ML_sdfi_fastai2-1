...
def get_model(model_name):
    ...
    elif model_name in ["efficientnetv2_s" ,"efficientnetv2_m","efficientnetv2_l","efficientnetv2_rw_s.ra2_in1k","efficientnetv2_rw_m.agc_in1k","tf_efficientnetv2_xl.in21k"]:
